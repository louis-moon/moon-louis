...
const essays = [
  {
  title: "A Rejection of Locke's Memory Theory of Personal Identity",
...
2   Locke's Memory Theory of Personal Identity
  
In his work, Locke argues that personal identity is a matter of memory continuity, which consists of one's ability to remember past thoughts and actions as their own. As a result, one should not be punished for performing an action that person does not recall having performed, for they are not the same person as the one who committed the action. I will examine how he arrives at this conclusion in the following paragraphs.
  
To begin, Locke defines a person as a “thinking intelligent being that has reason and reflection, and can consider itself as itself, the same thinking thing, in different times and places” (2.27.9). He takes consciousness to be the perception of what passes in one's mind, and believes it to be inseparable from and essential to thinking, for it is impossible for one to perceive without perceiving that one is perceiving. Since consciousness always accompanies thinking, and one must be a thinking being in order to be a person, he argues that the person with which one identifies with extends only as far back as one's consciousness does. Rather than being dependent on the continuity of a material substance such as the body, or an immaterial substance such as the mind, personal identity is solely grounded in this consciousness, or the sameness of a rational being. Any change in consciousness signifies a change in personal identity, and any change in personal identity implies that this consciousness has changed. Locke suggests that memory is a necessary and sufficient condition for sameness of consciousness, leading to the conclusion that two persons are the same if, and only if, one can remember the other's thoughts and actions. If one can remember committing some action, one in fact committed it. Conversely, if one cannot remember committing some action, then one did not commit it.
  
Locke goes on to define “person” as a forensic term, appropriating actions and their merit. When considering an action, I can see that I will be the same person in the future who will be punished for the actions I choose to commit now. When being punished in the future, I can reflect on the past and see that I am the same person who committed the action for which I am being punished. However, if I cannot remember committing an action, there has been a change in consciousness that signifies a change in personal identity. Thus, I cannot be morally responsible for an action I do not remember committing, for I am a different person and, accordingly, should not be punished for it.
  
3   Refutation of Locke's Memory Theory of Personal Identity
  
Locke's memory theory for personal identity ultimately fails due to his mistaken view that memory is a necessary and sufficient condition for sameness of person. In the following paragraphs, I will show that Locke's point of view leads to a contradiction.
  
Let us consider Thomas Reid's objection: “Suppose a brave officer to have been flogged when a boy at school for robbing an orchard, to have taken a standard from the enemy in his first campaign, and to have been made a general in advanced life; suppose, also, which must be admitted to be possible, that, when he took the standard, he was conscious of his having been flogged at school, and that, when made a general, he was conscious of his taking the standard, but had absolutely lost the consciousness of his flogging. These things being supposed, it follows, from Mr. Locke's doctrine, that he who was flogged at school is the same person who took the standard, and that he who took the standard is the same person who was made a general. Whence it follows, if there be any truth in logic, that the general is the same person with him who was flogged at school. But the general's consciousness does not reach so far back as his flogging; therefore, according to Mr. Locke's doctrine, he is not the person who was flogged. Therefore, the general is, and at the same time is not, the same person with him who was flogged at school.”
  
According to Locke's memory theory, memory is a necessary and sufficient condition for sameness of person. By this line of reasoning, if a person at a time T2 episodically remembers an experience that occurred at a time T1, then the person at T2 is the same as the person at T1. On the other hand, we can apply the law of transitivity to identity, for everything is identical to itself, wherein if A is identical to B and B is identical to C, then C is identical to A. If the officer recalls being flogged as a boy, then the officer is the same person as the boy. In addition, if the general recalls taking the standard as an officer, then the general is the same person as the officer. Finally, if the general is the same person as the officer, and the officer is the same person as the boy, then the general is the same person as the boy. However, given that memory is a necessary condition for sameness of person, Locke's memory theory leads to the conclusion that the general is not the same person as the boy, for he does not recall being flogged at school. Meanwhile, the law of transitivity demonstrates that the general is in fact the same person as the boy, thus leading to a contradiction. Identity is transitive, but memory continuity is not.
  
As a result, it is clear that memory is neither necessary nor sufficient for personal identity. I can suppose that memory is not a necessary condition, for I have experienced many events that I do not recall. It is true that only I can recall my experiences, but it is not my memory of an experience that makes it mine. Rather, an experience is mine because it is already mine by virtue of the fact that I did in fact experience it. Memory is also not a sufficient condition, for the concept of remembering contains within itself the characteristic that only I can remember my experiences. For me to remember committing an action is to remember myself committing it. To demonstrate this point, suppose we want to know if Jennifer, who exists at a time T2, is the same person as Michael, who we know to have existed at a time T1. Locke's memory theory of personal identity states that Jennifer is Michael if, and only if, Jennifer can recall Michael's past thoughts and actions. However, Jennifer's ability to recall one of Michael's past experiences can only be verified to be a genuine memory if Jennifer is in fact the same person as Michael, so we must know beforehand whether or not Jennifer is the same person as Michael before we can apply Locke's memory theory. Thus, it is circular reasoning and trivial to say that sameness of person is based on the concept of remembering, that memory continuity is sufficient for personal identity.
  
4   Potential Objection
  
I will now consider a potential objection to this counterargument. Perhaps Locke may offer a modification to his memory theory of personal identity that successfully avoids Reid's brave officer paradox. Such an objection is that a series of total temporary states belonging to a person preserves memory as a necessary and sufficient condition for sameness of person.
  
In response to this counterargument, Locke may adopt an amendment similar to the one that H.P. Grice proposes in his essay Personal Identity. Here, Grice introduces the term total temporary state (t.t.s.), which is “composed of all the experiences any one person is having at any given time.” He goes on to state that “in a series of total temporary states belonging to one person, every t.t.s. which is a member of that series will contain as an element a memory of some experience which is an element in the temporally preceding member of the series; in a series of total temporary states not belonging to one person this will not be the case.”
  
Such a modification preserves memory as a necessary and sufficient condition for personal identity, while also accounting for the transitive nature of identity. Memory is a necessary condition in that an element of a remembered experience is contained in at least one t.t.s. in the stream of total temporary states belonging to a person. The brave officer paradox is resolved, as the t.t.s. of the general contains in it an element also contained in the t.t.s. of the officer, and the t.t.s. of the officer contains in it an element also contained in the t.t.s. of the boy. That is to say this series of total temporary states belongs to one person, leading to the conclusion that the general is in fact the same person as the boy, even if he does not recall being flogged at school. Memory is also a sufficient condition in that the total temporary states in a stream belonging to a person share a transitive element: transitivity of total temporary states will fail if the states in question do not in fact belong to the same person. Similarly, this revised theory also holds true against false memories: mistakenly recalling have experienced an event is not equal to actually having experienced it. Thus, the series of total temporary states belonging to one person would not contain their false memories.
  
Locke would likely change his stance on the moral scenario, too: even if I cannot recall committing an action, an element of that remembered experience is contained in at least one t.t.s. in my stream of total temporary states. Therefore, I am morally responsible for an action I do not recall committing, for I am the same person and, accordingly, should be punished for it.
  
In response to this objection, the revised theory still falls short in defining what exactly constitutes sameness of person, just as Locke's original memory theory does. Rather than viewing personal identity as a substance in itself, it adopts a view similar to that of Hume, wherein persons are “nothing but a bundle or collection of different perceptions.” However, it succeeds in maintaining memory as a necessary and sufficient condition of personal identity, while also avoiding contradictions that arise when considering the transitivity of identity. As a result, it is sufficient in supporting Locke's point of view.
  
5   Conclusion
  
In this paper, I argued that Locke's memory theory of personal identity ultimately fails due to his mistaken view that memory is a necessary and sufficient condition for personal identity. This was realized by identifying contradictions that arise when considering the transitivity of identity. One could make an objection to my claim by modifying the original theory to account for a series of total temporary states belonging to a person that preserves memory as a necessary and sufficient condition. However, this objection still falls short in defining what exactly constitutes sameness of person, but is sufficient in supporting Locke's point of view.
`,
  tags: ["Philosophy", "Locke", "Personal Identity"],
},
  {
