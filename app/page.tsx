          ...
          <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-4">Expanding how I see the world</p>
                <ArrowRight className="w-5 h-5 text-primary group-hover:translate-x-1 transition-transform" />
              </Link>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-4">What matters most beyond work</p>
                <ArrowRight className="w-5 h-5 text-primary group-hover:translate-x-1 transition-transform" />
              </Link>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-4">Moments that shape who I am</p>
                <ArrowRight className="w-5 h-5 text-primary group-hover:translate-x-1 transition-transform" />
              </Link>
