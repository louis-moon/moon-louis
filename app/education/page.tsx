...
const coursework = [
  ...
  },
  {
    ...
    courses: [
      ...
      },
      {
        ...
        instructors: ["M. Chun", "N. Córdova Sánchez"],
      },
      {
        code: "S&DS 230",
  ...
  },
  {
    ...
    courses: [
      {
        code: "ECON 117",
        title: "Intro Data Analysis & Econometrics",
        instructors: ["N. Ryan"],
      },
      {
        code: "ENAS 130",
        title: "Computing for Engineers & Scientists",
        instructors: ["B. Bennett"],
      },
      {
        code: "KREN 132",
        title: "Intermediate Korean for Advanced Learners I",
        instructors: ["S. Choi"],
      },
  ...
  },
  {
    ...
    courses: [
      {
        code: "ASTR 130",
        title: "Origins and Search for Life in the Universe",
        instructors: ["D. Fischer"],
      },
      {
        code: "KREN 142",
        title: "Intermediate Korean for Advanced Learners II",
        instructors: ["A. Lee-Smith"],
      },
  ...
  },
  {
    ...
    courses: [
      {
        code: "ARCG 161",
        title: "Art & Myth in Greek Antiquity",
        instructors: ["M. Gaifman"],
      },
      {
        code: "ECON 251",
        title: "Financial Economics",
        instructors: ["E. Davila"],
      },
      { code: "S&DS 312", title: "Linear Models", instructors: ["J. Emerson"] },
      {
        code: "S&DS 365",
        title: "Data Mining & Machine Learning",
        instructors: ["S. Negahban"],
      },
    ],
  },
  {
    ...
    courses: [
      {
        code: "ASTR 160",
        title: "Frontiers & Controversies in Astrophysics",
        instructors: ["M. Geha"],
      },
      { code: "ENGL 114", title: "Kid Power", instructors: ["H. Klemann"] },
      {
        ...
        instructors: ["A. Pohoata"],
      },
      {
        code: "S&DS 674",
        title: "Applied Spatial Statistics",
        instructors: ["T. Gregoire"],
      },
    ],
  },
  {
    ...
    courses: [
      {
        code: "EDST S255",
        title: "Education and Housing Policy",
        instructors: ["R. Barnes"],
      },
  ...
  },
  {
    ...
    courses: [
      {
        code: "E&EB 250",
        title: "Biology of Terrestrial Arthropods",
        instructors: ["M. Wells"],
      },
      {
        code: "KREN 152",
        title: "Advanced Korean for Advanced Learners",
        instructors: ["A. Lee-Smith"],
      },
...
const testScores = [
  ...
  { test: "SAT Essay", score: "8/8/8", detail: "24/24" },
  {
    ...
    score: "2400/2400",
    detail: "Chemistry, Math II, US History",
  },
]
      ...
      <main className="min-h-screen pt-24 px-6 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="animate-fade-in mb-8">
            ...
            <h1 className="text-5xl md:text-6xl font-light mb-6">Education</h1>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative">
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {block.courses.map((c) => (
                          <div
                            key={c.code}
                            className="bg-primary/9 border border-primary/10 rounded-lg p-3"
                          >
              ...
              <div className="hidden md:block absolute right-0 top-0 bottom-6 w-20 bg-gradient-to-l from-background to-transparent pointer-events-none" />
            </div>
          </div>
          ...
          {/* Honors & Awards */}
          <div className="border border-dashed border-primary/30 rounded-2xl p-8 mb-8">
            <div className="flex items-start gap-3 mb-8">
                ...
                >
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {h.tags.map((t, j) => (
                      <span
                        key={j}
                        className="text-xs bg-primary/9 text-foreground px-2 py-1 rounded-md border border-primary/10"
                      >
                        {t}
                      </span>
                    ))}
          ...
          <div className="relative mb-8">
            ...
            <div className="relative">
              <div className="overflow-x-auto horizontal-scroll pb-6">
                <div className="flex gap-4 min-w-max pr-10">
                  {apScores.map((ap, i) => (
                    <div
                      key={i}
                      className="w-[220px] flex-shrink-0 bg-primary/9 border border-primary/10 rounded-lg p-4"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {extracurriculars.map((e, i) => (
                <div
                  ...
                  className="bg-card border border-primary/40 rounded-xl p-8 transition-all hover:border-primary hover:shadow-lg hover:shadow-primary/10"
                >
                  {/* Micro-spacing fix for "tight" cards */}
