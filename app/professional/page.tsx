    ...
    roles: [
      {
        ...
        bullets: [
          ...
          "Built digital golf twin product: a real-time virtual replica of golf courses to save inputs, manage risk, and boost profitability; worked closely with founders to support grant and fellowship applications, expand team, and validate product development",
        ],
      },
    ],
  },
